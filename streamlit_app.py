...
try:
    ...
    with tab1:
        ...
        with r3c2:
            ...
            v_n = clean_val(df_s.iloc[11, 2])   # שווי נוכחי (שורה 12, עמודה C)
            v_s = clean_val(df_s.iloc[11, 10])  # שווי תחילת שנה (שורה 12, עמודה K)
            v_d = clean_val(df_s.iloc[11, 16])  # הפקדות (שורה 12, עמודה Q)
