...
try:
    ...
    with tab1:
        ...
        debt_now = abs(clean_val(df_s.iloc[12, 2])) + abs(clean_val(df_s.iloc[13, 2]))
        debt_start = abs(clean_val(df_s.iloc[12, 4])) + abs(clean_val(df_s.iloc[13, 4]))
        ...
        with r2c2:
            # הורים - שורה 11 (אינדקס 10)
            p_n, p_s, p_d = df_s.iloc[10, 2], df_s.iloc[10, 4], df_s.iloc[10, 5]
        ...
        with r3c2:
            # חופשה - שורה 16 בגיליון SUMMARY (אינדקס 15)
            v_n, v_s, v_d = df_s.iloc[15, 2], df_s.iloc[15, 4], df_s.iloc[15, 5]
